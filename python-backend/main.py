#!/usr/bin/env python3
"""
Repo Summarizer - CLI Entry Point

A hackathon tool that summarizes GitHub repositories by combining
a Go-based file parser with Python-based AI/heuristic summarization.
"""
...
def main():
    ...
    console.print()
    console.print("[dim]Generated by Repo Summarizer - Built for Hackathons![/dim]")
    console.print()
